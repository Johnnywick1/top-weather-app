...
/* harmony import */ var _views_dailyView__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/dailyView */ "./src/views/dailyView.js");
/* harmony import */ var _views_queryView__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/queryView */ "./src/views/queryView.js");
...
const controlCurrentWeather = async function (location) {
  try {
    ...
    _views_currWeatherView__WEBPACK_IMPORTED_MODULE_2__.currWeatherView.renderCurrentWeather(
      currentWeather,
      locationName,
      timezoneOffset
    );
...
const controlHourlyForecast = async function (location) {
  try {
    ...
    _views_hourView__WEBPACK_IMPORTED_MODULE_1__.hourView.renderHourlyForecast(hourlyWeather, timezoneOffset, day1, day2);
  } catch (err) {
...
const controlDailyForecast = async function (location) {
  try {
    ...
    _views_dailyView__WEBPACK_IMPORTED_MODULE_3__.dailyView.renderDailyForecast(dailyWeather, timezoneOffset);
  } catch (err) {
...
const controlAddHandlerQuery = function () {
  _views_queryView__WEBPACK_IMPORTED_MODULE_4__.queryView.addHandlerGetQuery(controlGetQuery);
};
