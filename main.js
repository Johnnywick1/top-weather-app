...
/* harmony export */   "WEATHER_API_URL": () => (/* binding */ WEATHER_API_URL),
/* harmony export */   "LOC_API_KEY": () => (/* binding */ LOC_API_KEY),
/* harmony export */   "LOC_API_URL": () => (/* binding */ LOC_API_URL)
/* harmony export */ });
const WEATHER_API_KEY = `9f5a0a9571f86000054119d65c0d4f86`;

const WEATHER_API_URL = `https://api.openweathermap.org/data/2.5`;

const LOC_API_KEY = `pk.c204d4527b9ac16a572295302cc0c574`;

const LOC_API_URL = `https://us1.locationiq.com/v1/reverse.php`;
...
/* harmony export */   "convertToMilliseconds": () => (/* binding */ convertToMilliseconds),
/* harmony export */   "capitalize": () => (/* binding */ capitalize),
/* harmony export */   "convertDateToUTC": () => (/* binding */ convertDateToUTC),
...
/* harmony export */   "convertToFahr": () => (/* binding */ convertToFahr),
/* harmony export */   "convertToMph": () => (/* binding */ convertToMph),
/* harmony export */   "convertToMetersPerSec": () => (/* binding */ convertToMetersPerSec),
/* harmony export */   "convertToMiles": () => (/* binding */ convertToMiles),
/* harmony export */   "convertToKm": () => (/* binding */ convertToKm)
/* harmony export */ });
...
const convertToMilliseconds = function (sec) {
  return sec * 1000;
};
...
const getLocalTime = function (offset, dateToConvert) {
  let newDate;
...
const isDay = function (timeOfDay, day1, day2) {
...
const convertToFahr = function (celsius) {
  const fahr = (+celsius * 9) / 5 + 32;
  return fahr.toFixed(0);
};

const convertToMph = function (speed) {
  const mph = +speed * 2.236936;
  return mph.toFixed(0);
};

const convertToMetersPerSec = function (speed) {
  const ms = +speed * 0.44704;
  return ms.toFixed(0);
};

const convertToMiles = function (km) {
  const mile = +km * 1.609;
  return mile.toFixed(0);
};

const convertToKm = function (mile) {
...
const model = (function () {
  ...
  const getCityURL = function (city) {
    return `${_config__WEBPACK_IMPORTED_MODULE_0__.WEATHER_API_URL}/weather?q=${city}&units=metric&appid=${_config__WEBPACK_IMPORTED_MODULE_0__.WEATHER_API_KEY}`;
  };
  ...
  const getWeatherURL = function (coords) {
    ...
    return `${_config__WEBPACK_IMPORTED_MODULE_0__.WEATHER_API_URL}/onecall?lat=${lat}&lon=${long}&units=metric&exclude=minutely&appid=${_config__WEBPACK_IMPORTED_MODULE_0__.WEATHER_API_KEY}`;
  };
  ...
  const getLocationURL = function (coords) {
    ...
    return `${_config__WEBPACK_IMPORTED_MODULE_0__.LOC_API_URL}?key=${_config__WEBPACK_IMPORTED_MODULE_0__.LOC_API_KEY}&lat=${lat}&lon=${long}&format=json`;
  };
...
const View = (function () {
  ...
  const getCelsius = function (e) {
    ...
    tempValues.forEach((val) => {
      ...
      val.textContent = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.convertToFahr)(tempC);
    ...
    windSpeed.textContent = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.convertToMph)(speed);

    const vis = visDistance.textContent;
    visDistance.textContent = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.convertToMiles)(vis);
  ...
  const getFahrenheit = function (e) {
    ...
    tempValues.forEach((val) => {
      ...
      val.textContent = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.convertToCelsius)(tempF);
    ...
    const speed = windSpeed.textContent;
    windSpeed.textContent = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.convertToMetersPerSec)(speed);

    const vis = visDistance.textContent;
    visDistance.textContent = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.convertToKm)(vis);
...
const currWeatherView = (function () {
  ...
  const renderCurrentWeather = function (currentWeather, locationName, offset) {
    ...
    const timeOfDay = (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.isDay)(
      currentWeather.dt,
      [currentWeather.sunrise, currentWeather.sunset],
      []
    );

    const iconToDisplay = _View__WEBPACK_IMPORTED_MODULE_0__.View.getWeatherIcon(
      weatherStatusMain,
      weatherStatusID,
      timeOfDay
    );

    const iconEl = _View__WEBPACK_IMPORTED_MODULE_0__.View.renderIcon(iconToDisplay, weatherStatus);
    ...
    _View__WEBPACK_IMPORTED_MODULE_0__.View.clearSpace(currWeatherContainer);
    ...
    const indexEl = _View__WEBPACK_IMPORTED_MODULE_0__.View.createConditionElement(
      'thermometer',
      'Feels like  ',
      heatIndex,
      '°C'
    ...
    const humEl = _View__WEBPACK_IMPORTED_MODULE_0__.View.createConditionElement(
      'humidity',
      'Humidity ',
      humidity,
      '%'
    ...
    const speedEl = _View__WEBPACK_IMPORTED_MODULE_0__.View.createConditionElement(
      'strong-wind',
      'Wind Speed ',
      windSpeed,
      'm/s'
    ...
    const uvEl = _View__WEBPACK_IMPORTED_MODULE_0__.View.createConditionElement('sunrise', 'UV Index ', uvi, '');

    const cloudEl = _View__WEBPACK_IMPORTED_MODULE_0__.View.createConditionElement(
      'cloudy',
      'Cloud Cover ',
      cloudCover,
      '%'
    ...
    const pressureEl = _View__WEBPACK_IMPORTED_MODULE_0__.View.createConditionElement(
      'barometer',
      'Pressure ',
      pressure,
      'hPa'
    ...
    const dewEl = _View__WEBPACK_IMPORTED_MODULE_0__.View.createConditionElement(
      'raindrop',
      'Dew Point ',
      dewPoint,
      '°C'
    ...
    const visibilityEl = _View__WEBPACK_IMPORTED_MODULE_0__.View.createConditionElement(
      'wind-direction',
      'Visibility ',
      visibility,
      'km'
    ...
    _View__WEBPACK_IMPORTED_MODULE_0__.View.clearSpace(conditionsContainer);
  ...
  const renderWeatherStatus = function (status) {
    ...
    statusEl.textContent = (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.capitalize)(status);
  ...
  const renderDate = function (offset) {
    const [year, month, date] = (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocalTime)(offset);

    const dateToDisplay = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__.default)(
  ...
  const renderTime = function (offset) {
    ...
    const [year, month, date, hour, minute, second] = (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocalTime)(offset);

    const timeToDisplay = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__.default)(
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "dailyView": () => (/* binding */ dailyView)
/* harmony export */ });
/* harmony import */ var _View__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./View */ "./src/views/View.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers */ "./src/helpers.js");
/* harmony import */ var date_fns_format__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! date-fns/format */ "./node_modules/date-fns/esm/format/index.js");
...
const dailyView = (function () {
  const renderDailyForecast = function (dailyWeather, offset) {
    ...
    _View__WEBPACK_IMPORTED_MODULE_0__.View.clearSpace(forecastContainer);
  ...
  const createForecastElement = function (day, index, offset) {
    const timeToConvert = new Date((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.convertToMilliseconds)(day.dt));
    const [year, month, date, hourToUse] = (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocalTime)(offset, timeToConvert);

    const dayToDisplay = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__.default)(new Date(year, month, date, hourToUse), 'EEEE');
    ...
    const iconToDisplay = _View__WEBPACK_IMPORTED_MODULE_0__.View.getWeatherIcon(statusMain, statusID);
    ...
    const iconEl = _View__WEBPACK_IMPORTED_MODULE_0__.View.renderIcon(iconToDisplay, status);
...
const hourView = (function () {
  ...
  const createForecastElement = function (hour, offset, day1, day2) {
    ...
    const timeToConvert = new Date((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.convertToMilliseconds)(hour.dt));
    const [year, month, date, hourToUse] = (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocalTime)(offset, timeToConvert);

    const hourToDisplay = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__.default)(
      new Date(year, month, date, hourToUse),
      'haaa'
    );

    const timeOfDay = (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.isDay)(hour.dt, day1, day2);
    ...
    const iconToDisplay = _View__WEBPACK_IMPORTED_MODULE_0__.View.getWeatherIcon(statusMain, statusID, timeOfDay);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "queryView": () => (/* binding */ queryView)
/* harmony export */ });
const queryView = (function () {
...
/* harmony import */ var _views_hourView__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/hourView */ "./src/views/hourView.js");
/* harmony import */ var _views_currWeatherView__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/currWeatherView */ "./src/views/currWeatherView.js");
/* harmony import */ var _views_dailyView__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/dailyView */ "./src/views/dailyView.js");
/* harmony import */ var _views_queryView__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/queryView */ "./src/views/queryView.js");
...
const controlWeatherDisplay = async function (location) {
  try {
    ...
    // 0 Render spinner
    _views_View__WEBPACK_IMPORTED_MODULE_1__.View.renderSpinner();

    // 1 Get the city and country name
    const locationName = await _model__WEBPACK_IMPORTED_MODULE_0__.model.getCityAndCountry(location);
    ...
    _views_View__WEBPACK_IMPORTED_MODULE_1__.View.appendContainers();

    _views_currWeatherView__WEBPACK_IMPORTED_MODULE_3__.currWeatherView.renderCurrentWeather(
      currentWeather,
      locationName,
      timezoneOffset
    );

    _views_hourView__WEBPACK_IMPORTED_MODULE_2__.hourView.renderHourlyForecast(hourlyWeather, timezoneOffset, day1, day2);

    _views_dailyView__WEBPACK_IMPORTED_MODULE_4__.dailyView.renderDailyForecast(dailyWeather, timezoneOffset);

    // 7 Add handlers
    _views_View__WEBPACK_IMPORTED_MODULE_1__.View.addHandlerToggleTempUnits();
    _views_queryView__WEBPACK_IMPORTED_MODULE_5__.queryView.addHandlerGetQuery(controlWeatherDisplay);
  } catch (err) {
    _views_View__WEBPACK_IMPORTED_MODULE_1__.View.renderError(err.message);
  }
};
...
const controlPositionWeather = async function (position) {
  ...
  const location = await _model__WEBPACK_IMPORTED_MODULE_0__.model.getPositionName(latitude, longitude);
