...
const currWeatherView = (function () {
  ...
  const renderTime = function (offset) {
    const [year, month, date, hour, minute] = (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocalTime)(offset);
...
const controlAddHandlerQuery = function () {
  _views_queryView__WEBPACK_IMPORTED_MODULE_5__.queryView.addHandlerGetQuery(controlGetQuery);
};
