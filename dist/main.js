...
const currWeatherView = (function () {
  ...
  const renderDate = function (offset) {
    const [year, month, date] = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.getLocalTime)(offset);
  ...
  const renderTime = function (offset) {
    const [year, month, date, hour, minute] = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.getLocalTime)(offset);

    const timeToDisplay = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__.default)(
...
const dailyView = (function () {
  ...
  const createForecastElement = function (day, index, offset) {
    ...
    const timeToConvert = new Date((0,_helpers__WEBPACK_IMPORTED_MODULE_0__.convertToMilliseconds)(day.dt));
    const [year, month, date, hourToUse] = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.getLocalTime)(offset, timeToConvert);

    const dayToDisplay = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__.default)(new Date(year, month, date, hourToUse), 'EEEE');
    // console.log(day);
...
const hourView = (function () {
  ...
  const createForecastElement = function (hour, index, offset) {
    ...
    const timeToConvert = new Date((0,_helpers__WEBPACK_IMPORTED_MODULE_0__.convertToMilliseconds)(hour.dt));
    const [year, month, date, hourToUse] = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.getLocalTime)(offset, timeToConvert);

    const hourToDisplay = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__.default)(
...
const controlHourlyForecast = async function (location) {
  try {
    ...
    _views_hourView__WEBPACK_IMPORTED_MODULE_1__.hourView.renderHourlyForecast(hourlyWeather, timezoneOffset);
  } catch (err) {
