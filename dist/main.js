...
const currWeatherView = (function () {
  ...
  const renderDate = function (offset) {
    ...
    const toDisplay = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__.default)(new Date(year, month, date), 'yyyy MMM dd');
...
const controlCurrentWeather = async function (location) {
  try {
    ...
    _views_currWeatherView__WEBPACK_IMPORTED_MODULE_2__.currWeatherView.renderDate(timezoneOffset);
  } catch (err) {
